...
<div class="p-3">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
                        ...
                        <?php foreach ($reports as $r) :
                            ...
                            switch ($type) {
                                case 'spam':
                                    ...
                                    break;
                                case 'fake':
                                    $typeLabel = 'Thông tin sai lệch';
                                    $typeClass = 'bg-orange-100 text-orange-800';
                                    break;
                                case 'inappropriate':
                                    $typeLabel = 'Nội dung không phù hợp';
                                ...
                                case 'violence':
                                    ...
                                    break;
                                default:
                                    $typeLabel = $type !== '' ? htmlspecialchars($type) : 'Khác';
                                    $typeClass = 'bg-gray-100 text-gray-800';
                            }
                            ...
                            switch ($status) {
                                ...
                                case 'rejected':
                                    ...
                                    break;
                                default:
                                    $statusLabel = $status !== '' ? htmlspecialchars($status) : 'Chưa xác định';
                                    $statusClass = 'bg-gray-100 text-gray-800';
                            }
                        ?>
        ...
        <?php if (!empty($pagination) && $pagination['total_pages'] > 1) : ?>
            <div class="mt-8">
                <?= \Helpers\Pagination::render($pagination, BASE_URL . '/admin/reports', $queryParams) ?>
            </div>
        <?php endif; ?>
    </div>
...
<script>
    ...
    function openReportModal(id) {
        fetch(`${App.appURL}admin/reports/get/${id}`, {
