                                            ...
                                            <tr class="hover:bg-gray-50 transition-colors tenant-row" id="tenant-row-room-<?= $roomId ?>">
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap text-center text-sm font-medium border border-gray-300 w-12">
                                                    <div class="flex items-center justify-center space-x-4">
                                                        <!-- Edit Icon -->
                                                        <button onclick="editTenant(<?= $tenant['id'] ?>)" class="hover:scale-110 transition-transform" title="Chỉnh sửa">
                                                        ...
                                                        <!-- Delete Icon -->
                                                        <button onclick="deleteTenant(<?= $tenant['id'] ?>)" class="hover:scale-110 transition-transform" title="Xóa khách thuê">
...
<script>
    ...
    function populateEditForm(tenant, rooms) {
        // Set tenant ID (sử dụng tenant_id thay vì id)
        const tenantIdElement = document.getElementById('edit_tenant_id');
        if (tenantIdElement) {
            tenantIdElement.value = tenant.tenant_id;
        }
