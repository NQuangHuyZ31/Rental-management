                            ...
                            <table class="min-w-full border border-gray-300">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-center text-sm font-medium text-gray-700 border border-gray-300 w-12">Thao tác</th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr class="hover:bg-gray-50 transition-colors tenant-row" id="tenant-row-room-<?= $roomId ?>">
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap text-center text-sm font-medium border border-gray-300 w-12">
                                                    <div class="flex items-center justify-center space-x-2">
                                                        <button onclick="viewTenant(<?= $tenant['id'] ?>)" class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center hover:bg-blue-200 transition-colors" title="Xem chi tiết">
                                                            <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                                            </svg>
                                                        </button>
                                                        <button onclick="editTenant(<?= $tenant['id'] ?>)" class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors" title="Chỉnh sửa">
