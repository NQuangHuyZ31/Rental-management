...
<nav class="bg-gray-100 p-4">
    <div class="max-w-screen-xl container mx-auto">
        <div class="flex gap-6 justify-start overflow-x-auto">
            ...
            <!-- Khách chuyển khoản -->
            <a href="<?= BASE_URL ?>/landlord/banking" class="bg-white rounded-lg border border-green-200 p-3 flex flex-col items-center min-w-[140px] flex-shrink-0 hover:bg-gray-50 transition-colors">
                <div class="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center mb-2">
                    <i class="fas fa-dollar-sign text-white text-lg"></i>
                </div>
                <div class="text-gray-700 font-semibold text-sm text-center">Khách chuyển khoản</div>
            </a>
        </div>
    </div>
</nav>
