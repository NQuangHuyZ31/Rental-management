						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div class="form-control">
								...
								<span class="label-text">
									...
									Nhà trọ <span class="text-red-500">*</span>
								</span>
								</label>
								<select name="house" class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-emerald-500 transition-colors">
									<option value="">Chọn nhà trọ</option>
									<?php foreach ($houses as $house) { ?>
										<option value="<?php echo $house['id']; ?>"><?php echo $house['house_name']; ?></option>
									<?php } ?>
