...
<form id="filters" method='GET' class="w-full">
	<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
		...
		<div class="lg:col-span-1">
			<label class="block text-xs font-medium text-gray-700 mb-2">Tỉnh/Thành phố</label>
			<div class="relative">
				<div class="flex items-center bg-white border border-gray-300 rounded-lg px-3 py-3 hover:border-green-500 focus-within:border-green-500 focus-within:ring-1 focus-within:ring-green-500 transition-all shadow-sm">
					<i class="fas fa-map-marker-alt text-gray-400 text-sm mr-3 flex-shrink-0"></i>
		...
		<div class="lg:col-span-2">
			<label class="block text-xs font-medium text-gray-700 mb-2">Từ khóa tìm kiếm</label>
			<div class="relative">
				<div class="flex items-center bg-white border border-gray-300 rounded-lg px-3 py-3 hover:border-green-500 focus-within:border-green-500 focus-within:ring-1 focus-within:ring-green-500 transition-all shadow-sm">
		...
		<!-- Price Input -->
		<div class="lg:col-span-1">
			<label class="block text-xs font-medium text-gray-700 mb-2">Mức giá</label>
			<div class="relative">
				<div class="flex items-center bg-white border border-gray-300 rounded-lg px-3 py-3 hover:border-green-500 focus-within:border-green-500 focus-within:ring-1 focus-within:ring-green-500 transition-all shadow-sm">
					<i class="fas fa-dollar-sign text-gray-400 text-sm mr-3"></i>
					<select name="price" class="w-full bg-transparent border-none outline-none text-gray-900 text-sm cursor-pointer">
		...
		<!-- Area Input -->
		<div class="lg:col-span-1">
			<label class="block text-xs font-medium text-gray-700 mb-2">Diện tích</label>
			<div class="relative">
				<div class="flex items-center bg-white border border-gray-300 rounded-lg px-3 py-3 hover:border-green-500 focus-within:border-green-500 focus-within:ring-1 focus-within:ring-green-500 transition-all shadow-sm">
					<i class="fas fa-expand-arrows-alt text-gray-400 text-sm mr-3"></i>
					<select name="area" class="w-full bg-transparent border-none outline-none text-gray-900 text-sm cursor-pointer">
	...
	<div class="flex justify-center mt-6">
		<button type="submit" class="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-200 flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
