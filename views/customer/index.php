		...
		<div class="container mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
				...
				<a class="bg-white rounded-lg cursor-pointer shadow-md overflow-hidden hover:shadow-lg transition-shadow">
					...
					<div class="relative h-60 bg-gray-200">
						...
						<div class="absolute top-2 right-4 bg-white bg-opacity-90 rounded-full w-8 h-8 flex items-center justify-center">
							...
							<span class="absolute -top-1 -right-1 bg-red-500 text-white text-nowrap text-xs rounded-full w-4 h-4 flex items-center justify-center">5</span>
						</div>
					</div>
					...
					<div class="p-4">
						<h3 class="font-semibold text-gray-900 mb-2 text-sm leading-tight h-8">
							Cho thuê phòng trọ mới 20m2 giá tốt.
						</h3>
						<div class="flex items-center text-sm text-gray-600 mb-3 text-nowrap overflow-hidden">
							<i class="fas fa-user text-gray-400 mr-2"></i>
							<span>Chị Hương - Thanh Trì . Hà Nội</span>
						</div>
						<div class="flex items-start justify-between flex-col">
							<div class="flex items-center gap-2">
								<span class="text-gray-400 line-through text-sm mr-2">2.700.000₫</span>
								<span class="bg-red-500 text-white text-nowrap text-[9px] px-2 py-1 rounded">8% OFF</span>
							</div>
							<div class="text-right flex w-full items-center justify-between pt-1">
								<div class="text-[16px] font-bold text-red-600">2.500.000đ/tháng</div>
				...
				<a class="bg-white rounded-lg cursor-pointer shadow-md overflow-hidden hover:shadow-lg transition-shadow">
					...
					<div class="p-4">
						<h3 class="font-semibold text-gray-900 mb-2 text-sm leading-tight h-8">
							Phòng trọ Gò Vấp, mới, full nội thất tại Phường 14, Gò Vấp, Thành p...
						</h3>
						<div class="flex items-center text-sm text-gray-600 mb-3 text-nowrap overflow-hidden">
							<i class="fas fa-user text-gray-400 mr-2"></i>
							<span>Thảo - Gò Vấp . Thành phố Hồ Chí Minh</span>
						</div>
						<div class="flex items-start justify-between flex-col">
							<div class="flex items-center gap-2">
								<span class="text-gray-400 line-through text-sm mr-2">4.300.000₫</span>
								<span class="bg-red-500 text-white text-nowrap text-[9px] px-2 py-1 rounded">3% OFF</span>
							</div>
							<div class="text-right flex w-full items-center justify-between pt-1">
								<div class="text-[16px] font-bold text-red-600">4.200.000đ/tháng</div>
								<div class="text-sm text-gray-600 font-medium mr-3">18m2</div>
							</div>
						</div>
					</div>
				</a>
				...
				<a class="bg-white rounded-lg cursor-pointer shadow-md overflow-hidden hover:shadow-lg transition-shadow">
					...
					<div class="p-4">
						<h3 class="font-semibold text-gray-900 mb-2 text-sm leading-tight h-8">
							Cho thuê phòng trọ Hoàng Quốc Việt, Nghĩa Tân, Cầu Giấy
						</h3>
						<div class="flex items-center text-sm text-gray-600 mb-3 text-nowrap overflow-hidden">
							<i class="fas fa-user text-gray-400 mr-2"></i>
							<span>Huyền - Cầu Giấy . Hà Nội</span>
						</div>
						<div class="flex items-start justify-between flex-col">
							<div class="flex items-center gap-2">
								<span class="text-gray-400 line-through text-sm mr-2">3.000.000₫</span>
								<span class="bg-red-500 text-white text-nowrap text-[9px] px-2 py-1 rounded">7% OFF</span>
							</div>
							<div class="text-right flex w-full items-center justify-between pt-1">
								<div class="text-[16px] font-bold text-red-600">2.800.000đ/tháng</div>
								<div class="text-sm text-gray-600 font-medium mr-3">28m2</div>
							</div>
						</div>
					</div>
				</a>
				...
				<a class="bg-white rounded-lg cursor-pointer shadow-md overflow-hidden hover:shadow-lg transition-shadow">
					...
					<div class="p-4">
						<h3 class="font-semibold text-gray-900 mb-2 text-sm leading-tight h-8">
							Cho thuê căn hộ rộng rãi, an ninh, đầy đủ nội thất H.Nhà Bè
						</h3>
						<div class="flex items-center text-sm text-gray-600 mb-3 text-nowrap overflow-hidden">
							<i class="fas fa-user text-gray-400 mr-2"></i>
							<span>Kitty - Nhà Bè . Hồ Chí Minh</span>
						</div>
						<div class="flex items-start justify-between flex-col">
							<div class="flex items-center gap-2">
								<span class="text-gray-400 line-through text-sm mr-2">3.300.000₫</span>
								<span class="bg-red-500 text-white text-nowrap text-[9px] px-2 py-1 rounded">25% OFF</span>
							</div>
							<div class="text-right flex w-full items-center justify-between pt-1">
								<div class="text-[16px] font-bold text-red-600">2.500.000đ/tháng</div>
								<div class="text-sm text-gray-600 font-medium" mr-3>120m2</div>
							</div>
						</div>
					</div>
				</a>
