...
use App\Controllers\Customer\RentalPostRoomController;
use App\Controllers\Customer\RentalPostRoommateController;
...
$router->get('/o-ghep-pass-phong', [RentalPostRoommateController::class, 'searchByFilter']);
$router->get('/nha-cho-thue', [RentalPostHouseController::class, 'searchByFilter']);
$router->get('/van-phong', [RentalPostOfficeController::class, 'searchByFilter']);
...
$router->post('/customer/interests/delete', [InterestCustomerController::class, 'deletePostInterest'], [AuthMiddleware::class]);
...
$router->get('/admin/post-news', [PostManagementController::class, 'index'], [AuthAdminMiddleware::class]);
$router->post('/admin/posts/create', [PostManagementController::class, 'create'], [AuthAdminMiddleware::class]);
$router->get('/admin/posts/get', [PostManagementController::class, 'getPost'], [AuthAdminMiddleware::class]);
